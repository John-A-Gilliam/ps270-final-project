...
```{r, echo=FALSE}
ggplot(pop_religion, aes(x = `Electoral Democracy Index`, fill = as.factor(Christians))) +
...
ggplot(pop_religion, aes(x = `Electoral Democracy Index`, fill = as.factor(Muslims))) +
  geom_histogram(alpha = 0.5, position = "identity", bins = 20) +
...
```{r, echo=FALSE}
ggplot(pop_religion, aes(x = as.factor(Christians), y = `Electoral Democracy Index`, fill = as.factor(Christians))) +
...
ggplot(pop_religion, aes(x = as.factor(Muslims), y = `Electoral Democracy Index`, fill = as.factor(Muslims))) +
  geom_boxplot(alpha = 0.6, outlier.shape = NA, color = "#444444") + 
  geom_jitter(width = 0.2, alpha = 0.4, size = 1.5) + 
